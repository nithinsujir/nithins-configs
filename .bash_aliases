...
alias gichd='git checkout default-4.4'
alias gich='git checkout'
alias gicl='git clone'
alias gidc='git diff --cached'
alias gid='git diff'
#alias gie='git send-email --no-signed-off-by-cc --smtp-server=mail.tintri.com'
#alias GIE='git send-email --smtp-server=mail.tintri.com'
alias GIENDEV='git send-email --to davem@davemloft.net --cc netdev@vger.kernel.org'
alias giendev='git send-email --to davem@davemloft.net --cc netdev@vger.kernel.org --dry-run'
alias gien='git send-email --suppress-cc=all --no-signed-off-by-cc --to nsujir@tintri.com'
#alias GIES='git send-email --smtp-server=mail.tintri.com --to stable@vger.kernel.org'
...
#alias ls='ls --color'
alias lss='lsscsi'
alias mbun='sudo mount -t cifs -o noperm,uid=$USER,username=Tintri\\nsujir //support-nas-n.tintri.com/Bundles /bundles'
...
alias tara='tsh auto-runs-archive'
...
# Tintri Build
alias ws='export TOPDIR=/data/workspaces/build0; . $TOPDIR/platform/misc/scripts/devel_funcs; cd $TOPDIR/platform/os; . $HOME/.bf'
alias ws1='export TOPDIR=/data/workspaces/build1; . $TOPDIR/platform/misc/scripts/devel_funcs; cd $TOPDIR/platform/os; . $HOME/.bf'
alias ws2='export TOPDIR=/data/workspaces/build2; . $TOPDIR/platform/misc/scripts/devel_funcs; cd $TOPDIR/platform/os; . $HOME/.bf'
alias ws3='export TOPDIR=/data/workspaces/build3; . $TOPDIR/platform/misc/scripts/devel_funcs; cd $TOPDIR/platform/os; . $HOME/.bf'
alias ws4='export TOPDIR=/data/workspaces/build4; . $TOPDIR/platform/misc/scripts/devel_funcs; cd $TOPDIR/platform/os; . $HOME/.bf'
alias ws5='export TOPDIR=/data/workspaces/build5; . $TOPDIR/platform/misc/scripts/devel_funcs; cd $TOPDIR/platform/os; . $HOME/.bf'
alias ws6='export TOPDIR=/data/workspaces/build6; . $TOPDIR/platform/misc/scripts/devel_funcs; cd $TOPDIR/platform/os; . $HOME/.bf'

alias ix='cd $TOPDIR/platform/os/extdrivers/intel/enet/ixgbe-3.11.33/src'
alias os='cd $TOPDIR/platform/os; . $TOPDIR/platform/misc/scripts/devel_funcs; . $HOME/.bf'
alias fs='cd $TOPDIR/fs; . $TOPDIR/platform/misc/scripts/devel_funcs; . $HOME/.bf'
alias ui='cd $TOPDIR/ui; . $TOPDIR/platform/misc/scripts/devel_funcs; . $HOME/.bf'
