...
alias hbd='hh bookmark -d'
alias hd='hh vd'
alias hdc='hh diff -g -c .'
alias hgb='hh bookmarks'
...
alias hgk='hh backup'
alias hgo='hg out -r .'
alias HGP='hh purge --all'
alias HGR='hh revert --all'
alias hgs='hh status'
alias hgv='hh backup && hh review'
...
alias UD='umount /data /data2 /data3'
