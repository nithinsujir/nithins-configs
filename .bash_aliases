...
alias ws1='export TOPDIR=/data3/workspaces/build1; . $TOPDIR/platform/misc/scripts/devel_funcs; cd $TOPDIR/platform/os; . $HOME/.bf'
alias ws2='export TOPDIR=/data2/workspaces/build2; . $TOPDIR/platform/misc/scripts/devel_funcs; cd $TOPDIR/platform/os; . $HOME/.bf'
alias ws3='export TOPDIR=/data2/workspaces/build3; . $TOPDIR/platform/misc/scripts/devel_funcs; cd $TOPDIR/platform/os; . $HOME/.bf'
alias ws4='export TOPDIR=/data3/workspaces/build4; . $TOPDIR/platform/misc/scripts/devel_funcs; cd $TOPDIR/platform/os; . $HOME/.bf'
alias ws5='export TOPDIR=/data3/workspaces/build5; . $TOPDIR/platform/misc/scripts/devel_funcs; cd $TOPDIR/platform/os; . $HOME/.bf'
alias ws6='export TOPDIR=/data3/workspaces/build6; . $TOPDIR/platform/misc/scripts/devel_funcs; cd $TOPDIR/platform/os; . $HOME/.bf'
