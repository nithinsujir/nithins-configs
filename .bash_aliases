...
alias ssh='ssh -Y -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no'
...
alias nvm='ssh -Y nsujir-vm'
alias nvm2='ssh -Y nsujir-vm2'
alias nvm3='ssh -Y nsujir-vm3'
alias nvm4='ssh -Y nsujir-vm4'
alias nws='ssh -Y nsujir-ws'
alias pxe='ssh -Y pxesrv1'
alias tvm='ssh -Y test-vm205'
alias uvm='ssh -Y nsujir-ubuntu14'
